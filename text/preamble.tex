...
\title{Cattle, Steaks and Restaurants:\\
Development Accounting when Space Matters}

\author{Péter Karádi (ECB)\\
Miklós Koren (CEU, IEHAS and CEPR)}
