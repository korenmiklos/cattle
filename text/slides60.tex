...
\begin{frame}\frametitle{Proof of Proposition 1$\cdot$}
\begin{itemize}
...
\begin{frame}\frametitle{Demand for residential land increases with development$\cdot$}
\begin{itemize}
...
\begin{frame}\frametitle{Income and the demand for housing$\cdot$}
\begin{table}[h!]
\center
\begin{tabular}{l|cc}
  \hline\hline
...
\longfigure{dh-prices}{Rent gradient became steeper$\cdot$}
\time 1
...
\begin{frame}\frametitle{Tradable sectors move out of cities$\cdot$}
\begin{itemize}
...
\widefigure{LQ_map}{Locational quotient of tradable sectors$\cdot$}
\widefigure{LQ_scatter}{Tradables stay away from dense counties$\cdot$}
\widefigure{deurbanization}{Industries move away from dense counties}
\time 1

\begin{frame}
\frametitle{Proximity to population and inflation}
\begin{center}
\begin{tabular}{l|cc}
\hline\hline
