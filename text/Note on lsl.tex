...
\pagestyle{fancy} \lhead{} \chead{Location specific labor}
\rhead{}
...
\]
where $\gamma$ is the CD share of housing in consumption expenditure. This assumes $T=0$ (absentee landlord), but is also valid for rents redistributed in proportion to wage income. 
...
\[
\ln w(z) = c + z\frac{\tau_i/\beta - \tau_h/\gamma}{1-1/\beta-1/\gamma},
\]
which decreases in $z$ if and only if $\tau_i/\beta > \tau_h/\gamma$.
