...
Rich countries are more expensive than poor ones. Figure \ref{fig:sc_penn_joint} shows
...
\end{proposition}
\begin{proposition}
All of these effects are stronger countries with bigger cities.
\end{proposition}
...
\dofigure{sc_penn}{Development, urbanization, and price levels}
...
Our model suggests that development leading to higher income of consumers implies an increase in the demand for residential land, resulting in an equilibrium with higher residential land area and prices. Our results also require that the land share in income increases with development (see Proposition 2.). These characteristics are all present in the U.S.~time-series data. Overman, Puga and Turner, 2006 find that the per capita residential land use between 1976 and 1992 \emph{increased by 25.4\%}, based on the highest available resolution data of land use based on aerial and satellite photographs.\footnote{The 1992 data is based on 8.7 million 30 x 30 meters cells, which are classified as developed if at least 30\% of it is covered by constructed materials.}  Davis and Heathcote, 2007 find that the implied real price of residential land\footnote{To get this data, the authors use
data on construction costs and decompose the value of an
average home to replacement value and land value.} was increasing substantially during the period (see figure \ref{fig:dh-shares}) -- clearly showing increasing demand for land. The figure also shows that between 1950 and 2000 the residential land prices increased nine-fold, while the share of land in the value of the aggregate housing stock increased from 10.4\% to 36.4\%.

\dofigure{dh-shares}{Land prices and the share of land in home value\newline
\small Source: Davis and Heathcote (2007).}

Burchfield, Overman, Puga and Turner, 2006 also documents that U.S.~commercial land is, on average, substantially more scattered than residential land, and the probability that a commercial land is surrounded by undeveloped land is much higher in 1992 than it was in 1976. It indirectly means that an average commercial land user does not need to compete for scarce land. This hypothesis is further supported by the relative price developments of residential and farm land derived by Davis and Heathcote, 2007 and shown by figure \ref{fig:dh-prices}. The graph reveals some short term relationship between the two prices, but also shows an increasing rent gradient (gap between residential and land prices) in the long term providing saving opportunities for sectors willing to locate further from the consumers.

\dofigure{dh-prices}{Real residential and farm land prices (log scale)\newline
\small Source: Davis and Heathcote (2007).}

Our main conjecture is that the residential price developments were closely related to the per capita income growth observable in the U.S.~during the period. Davis and Heathcote, 2007 present some supporting time-series results by regressing their implied real land prices (in logs) on per capita real disposable personal income (in logs), nominal interest rate and inflation rate using a quarterly dataset between 1975:4 and 2005:4. They have found significant coefficients with an income elasticity of 2.6. Using the cross-sectional dataset of Davis and Palumbo (2008) with implied residential land prices for 46 large U.S.~metropolitan areas, we find very similar results (see table \ref{tab:land}, column 3.).

\dofigure{sc_davis}{Land prices and income across large U.S.~cities}

Figure \ref{fig:sc_davis} plots the (log) price of land against
...
of 2.8. This is consistent with our model, in which the complementarity between land and consumption leads to an amplified response of rents to income. The last column of table \ref{tab:land} regresses the average per capita number of rooms on income and population using county level data published by the Census Bureau. It supports the conjecture that higher income does indeed lead to higher housing and thus land demand.
...
alternative taking commuting habits into consideration, but,
naturally, do not covering the whole country. Our regressions are
robust to using MSAs.} As before, we used the
...
population and the relative non-tradable/tradable employment for U.S.~states, strongly supporting the conjectured positive relationship.
