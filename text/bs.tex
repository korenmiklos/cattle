...
Our model suggests that development leading to increasing income of consumers implies an increase in the demand for residential land, which leads to an equilibrium with higher residential land area and prices. Our model also requires that the land share in income increases with development. These characteristics are all present in the US time series data. Overman, Puga and Turner, 2006 finds that the per capita residential land use between 1976 and 1992 \emph{increased by 25.4\%}, based on the highest available resolution data\footnote{The 1992 data is based on 8.7 million 30 x 30 meters cells, which are classified as developed if at least 30\% of it is covered by constructed materials.} of the US land use based on aerial and satellite photographs. Davis and Heathcote, 2007 finds that the implied real price of residential land\footnote{To get this data, the authors use
data on construction costs and decompose the value of an
average home to replacement value and land value.} was increasing substantially during the period (see figure \ref{fig:dh_shares}) -- clearly showing increasing demand for land. The figure also shows that between 1950 and 2000 it increased nine-fold, while the share of land in the value of the aggregate housing stock increased from 10.4\% to 36.4\%.
...
non-tradables have to be produced close to the consumers, while tradables can more easily economize on lower land prices further away. In this section we overview evidence on US data related to the level and the development of the co-location (spatial correlation) of the population and various industries, namely, mainly manufacturing and services.\footnote{Agriculture and mining, as a result of their relatively low trade costs and high land share, are naturally located in the least densely populated counties (see Holmes and Stevens, 2003, Table 10.)}

The post war deconcentration of manufacturing has been widely documented in the literature. Holmes and Stevens, 2004 documents that the spatial distribution of manufacturing has become much more even between 1947 and 1999, and finds that they are substantially underrepresented in areas with high population density. Desmet and Fafchamps, 2006, similarly, finds that manufacturing has become more deconcentrated between 1970 and 2000.\footnote{Burchfield, Overman, Puga and Turner, 2006 also documents that US commercial land is, on average (as they do not have the data to categorize it by industries), substantially more scattered than residential land, and the probability that a commercial land is surrounded by undeveloped land is much higher in 1992 than in 1976.} Because of the very high spatial correlation of population and employment, it is not surprising that the same studies have also found that -- in line with our model -- the spatial distribution of services developed in line with those of the population. \footnote{The direction of population, and thus services, concentration in the U.S. depends on how you look at it. An average county experienced a population as services concentration, as documented by Desmet and Fafchamps, 2006, bus as there were population deconcentration in the most densely populated areas as was documented by Chatterjee and Carlino, 2001 over U.S.~metropolitan areas, an average person has observed a population, *** and services? deconcentration during the period.} 

A way to measure the co-location of sectors and population is to calculate the locational quotient ($q_i$), which is measured as the ratio of an area's ($i$) share in the U.S.~sectoral employment ($s_i$) and its share in the U.S.~overall employment ($x_i$). If $q_i$ is below 1, the area is underrepresented in that sector, while substantially higher than 1 locational quotients mean the area is specialized in the certain sector. Figure \ref{fig:LQ_map} shows the locational quotient of the tradable sectors over the U.S.~counties, and it shows that these sectors are underrepresented in the most dense counties. *** We might need a map with population density to make this point more obvious!***
...
Figure \ref{fig:LQ_scatter} shows the strong negative relationship between the population density and the locational quotient for the 3219 U.S.~counties for 2000 (?, note: typo in the graph!***).
...
The time series development of the relative manufacturing employment is presented in figure \ref{fig:deurbanization}, that plots the share of the 100 most densely populated counties in total employment and in manufacturing between 1986 and 2005 using the dataset provided by the County Business Patterns. It shows that the relative share of these counties has decreased in both respects implying deconcentration, but the relative share of manufacturing has decreased faster implying increase in relative services/manufacturing employment. 
...
An implication of this spatial assumption is that higher urbanization and population density in an area would imply higher relative employment in the non-tradable sectors than in the tradeable ones. We have examined this mechanism by looking at the US Census 2000
