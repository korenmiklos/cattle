...
Rich countries are more expensive than poor ones. Figure *** shows
the strong correlation of the aggregate price level relative to the
U.S. against (PPP-adjusted) GDP per capita for 188 countries in 2000
available in the Penn World Table. Balassa (1964) and Samuelson
(1964) suggested a simple and powerful explanation based on the
observation that aggregate total factor productivity growth tends to
come from the productivity growth of tradables, like manufacturing,
and much less from the productivity growth of non-tradables, like
...
Obstfeld-Rogoff, 1999)\footnote{Hsieh and Klenow (1997) recently
...
empirical results also support the assumption that total factor
