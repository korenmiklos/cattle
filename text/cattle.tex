...
[FIXME: Define as small city equilibrium.]
...
\]
\[
\zeta_{1c}\exp(-z_1 \tau_1/\beta)=
\zeta_{2c}\exp(-z_1 \tau_2/\beta)
\]
\[
\left(\frac {P_{1c}A_{1c}}
	{P_{2}A_{2c}}
...
\]
The relative price of services and manufacturing is
\[
\frac {P_{1c}}
	{P_{2}}
= \frac {A_{2c}} 
...
For a small city with given $N_c$ and $P_2$, $P_3$, there are 5 equations in 5 unknowns: $z_1$, $z_2$, $P_1/P_2$, $R_1/R_2$, $W/P_3$.
