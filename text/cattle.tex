...
\[
Q_i(z) = A_i N_i(z)^{\alpha_i}L_i(z)^{1-\alpha_i}.
\]
Sectors differ in their labor share $\alpha_i$ and Hicks neutral productivity shifter $A_i$.
...
Workers can choose their location freely.
\end{document}
